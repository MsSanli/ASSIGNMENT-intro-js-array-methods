...
const search = (event) => {
  ...
  const searchResult = referenceList.filter(thang =>
    thang.title.toLowerCase().includes(userInput) ||
    thang.author.toLowerCase().includes(userInput) ||
    thang.description.toLowerCase().includes(userInput)
    )
